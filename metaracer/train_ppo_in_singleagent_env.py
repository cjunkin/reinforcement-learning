...
ENVIRONMENT_CONFIG = dict(
    ...
    # Reward function
    crash_sidewalk_penalty = 75,  # default = 50, prev = 10.0
    success_reward = 150,  # default = 100, prev = 15.0
    speed_reward = 30,  # default = 0, prev = 20.0
    driving_reward = 3,  # prev = 1.0
    idle_penalty = 150,  # prev = 50.0 (next = 200)
...
if __name__ == '__main__':
    ...
    result_recorder = dict(
        ...
        progress=deque(maxlen=30_000)  # ADDED
    )
